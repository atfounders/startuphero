...
?>
		...
		<footer id="colophon" class="site-footer" role="contentinfo">
			<div class="site-info">
				...
				<a href="http://atfounders.com" title="A Founders Project">A Founders Project</a>
				<span class="sep"> | </span>
				...
				<span class="sep"> | </span>
				<?php printf( __( 'Theme: %1$s by %2$s.', 'confit' ), 'Confit', '<a href="http://automattic.com/" rel="designer">Automattic</a>' ); ?>
			</div><!-- .site-info -->
